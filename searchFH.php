...
<!-- Code for trip submission -->
      ...
      <div id="flights" style="font-family:Courier; font-size: 15px; border-style: groove;">
        <h1 style="color: black" class="ftext">Select Your Trip Type</h1>
...
<!-- Fetching  return Location -->
            ...
            <p><label style="color: black" style="display: solid block" id="label0" class="ftext">Depart date:</label>
            <input required="" type="text" name="depart_date" id="datepicker1"  placeholder="month/day/year" /></p>
            <p><label style="color: black" style="display:solid block" id="label1" class="ftext" >Return date:</label>
...
<!-- Fetching  return Location -->
            ...
            <p><label style="color: black" style="display: solid block" id="label0" class="ftext">Date:</label>
